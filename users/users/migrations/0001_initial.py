    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('membre', 'Membre'), ('visiteur', 'Visiteur')], max_length=10)),
                ('phone_number', models.CharField(blank=True, max_length=50, null=True)),
                ('photo', models.ImageField(blank=True, null=True, upload_to='static/images/personnes/')),
