    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('point_focal', 'Point Focal'), ('responsable', 'Responsable'), ('suiveur_evaluateur', 'Suiveur Evaluateur'), ('cabinet', 'Cabinet MFB'), ('visiteur', 'Visiteur')], max_length=20)),
